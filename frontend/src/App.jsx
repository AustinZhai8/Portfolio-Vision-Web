...
export default function App() {
  // Keeps title/description/canonical/OG/JSON-LD in step with the current route
  // after client-side navigation. Initial load is already correct via the static
  // shell generated by scripts/generate-html.mjs.
  useSeo();
